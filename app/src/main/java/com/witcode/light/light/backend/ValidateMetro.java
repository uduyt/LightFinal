...
public class ValidateMetro extends MyServerClass implements OnTaskCompletedListener {
    ...
    public ValidateMetro(Context context, String station, Location location, OnTaskCompletedListener listener) {
        super(context);
        mCallback = listener;
        mLocation = location;
        mStation = station;
    ...
    private void SetUp(){
        ...
        final String REQUEST_BASE_URL =
                "http://www.sustainabilight.com/functions/validate_metro.php?";
