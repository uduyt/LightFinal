...
public class ValidateUrbanBus extends MyServerClass implements OnTaskCompletedListener {
    ...
    public ValidateUrbanBus(Context context, String line, Location location, OnTaskCompletedListener listener) {
        super(context);
        mCallback = listener;
        mLocation = location;
        mLine = line;
    ...
    private void HandleResult(String result){
        try {
            ...
            if (dataObject1 != null) {
                ...
                if (dataObject != null) {
                    ...
                    if (jsonStop.optJSONObject("line").getString("line").equals(mLine)) {
                        mCallback.OnComplete("", ValidateUrbanBus.VALIDATED, SUCCESSFUL);
                        return;
                    }
                } else {
                    //array
            ...
            mCallback.OnComplete(result, ValidateUrbanBus.TOO_FAR, SUCCESSFUL);
